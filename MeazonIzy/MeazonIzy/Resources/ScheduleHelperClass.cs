   ...
   public class ScheduleHelperClass
    {
        ...
        public ObservableCollection<MySchedule> DisirializeSchedule(Schedule schedule)
        {
            ...
            try
            {
                ...
                //PWS THA GINEI?
                //STO SCHEDULE RESOUCES THA CANW CALL OLA TA SCHEDULES KAI THA TA PAIRNW WS MIA LISTA
                //KLASHS SCHEDULE META GIA KATHE SCHEDULE THA KALW SUNARTHSH DESIRIALIZE
                //KAI THA PARAGW ENA ANTISTOIXO MYSCHEDULE KAI OLA AUTA THA TA EISAGW SE MIA LISTA MYSCHEDULE
                //OTAN THA THELW NA PROSTHESW THA KALW TO API KAI THA TOU STELNW TO B64 STRING
                //OLA TA PARAPANW THA EXOUN KAI KAPOIOUS KANONES POU THA DIAKRINOUN TO KATHE ENA
